      ...
      <div className="mx-auto w-full max-w-6xl px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12 max-w-4xl mx-auto">
          {Object.entries(plans).map(([key, plan]) => (
            <div
              key={key}
              className={`relative border-2 transition-all duration-300 rounded-2xl bg-card p-6 md:p-8 ${
                plan.popular
            ...
            >
              ...
              <div className="space-y-6 mt-6">
                ...
                <Link
                  ...
                  className={`inline-flex items-center justify-center w-full rounded-md px-4 py-2 font-medium transition-colors ${
                    plan.popular
